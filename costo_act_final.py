...
def user_input_features():
    ...
    Tipo=st.number_input("Tipo(transporte:0,alimentos:1,ahorro:2,entretenimiento:3,academico:4,ejercicio:5",min_value=0,max_value=5,value=1,step=1,)

    Momento=st.number_input("Momento(mañana:0,tarde:1,noche:2",min_value=0,max_value=2,value=1,step=1,)
